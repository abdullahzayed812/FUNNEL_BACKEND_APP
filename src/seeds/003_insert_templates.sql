...
VALUES
  ('template_1', '', 'Default', 'offer', 'Medical', 
  ...
  ('template_2', '', 'Default', 'offer', 'Medical', 
  ...
  ('template_3', '', 'Default', 'offer', 'Business', 
  ...
  ('template_4', '', 'Default', 'launching', 'Business', 
  ...
  ('template_5', '', 'Default', 'launching', 'Real State', 
  "<svg width='1080' height='1080' viewBox='0 0 1080 1080' fill='none' xmlns='http://www.w3.org/2000/svg'>n<rect x='97.5' y='263.5' width='885' height='553' rx='15.5' fill='black' fill-opacity='0.45' stroke='white' stroke-width='3'/></svg>", 
  '#e96c3f', 
  '', 
  CURRENT_TIMESTAMP, '1'),

  ('template_6', '', 'Default', 'launching', 'Real State', 
