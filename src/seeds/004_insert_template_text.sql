...
VALUES
  ...
  ('3', 'cta', 36, 'PlayfairDisplay-Bold', 'normal', 'none', 'normal', 20, 0, 'solid', 'transparent', 'secondary', 'en', 0.05, 0.3, '#FFFFFF', 'template_1', 'Book now', NULL, 'primary'),
...
-- Inserting second set of template texts (template_2)
  ...
  ('6', 'cta', 36, 'the-bold-font', 'bold', 'none', 'normal', 0, 3, 'solid', '#fff', 'transparent', 'en', 0.08, 0.3, '#FFFFFF', 'template_2', 'Book Now', NULL, 'primary'),

-- Inserting third set of template texts (template_3)
  ('7', 'headline', 64, 'Caveat-Bold', 'normal', 'none', 'normal', 0, 0, 'solid', 'transparent', 'transparent', 'en', 0.43, 0.6, 'secondary', 'template_3', 'Income Knocks!', NULL, NULL),
  ...
  ('9', 'cta', 36, 'RobotoCondensed-Black', 'bold', 'none', 'normal', 10, 0, 'solid', 'transparent', 'transparent', 'en', 0.73, 0.82, '#FFFFFF', 'template_3', 'Book Now', 'primary', NULL),
  ...
  ('12', 'cta', 36, 'RobotoCondensed-Black', 'bold', 'none', 'normal', 10, 0, 'solid', 'transparent', 'transparent', 'en', 0.43, 0.86, '#ffffff', 'template_4', 'Book Now', NULL, 'primary'),
...
-- Inserting text data for template_5
  ...
  ('15', 'cta', 36, 'RobotoCondensed-Black', 'bold', 'none', 'normal', 10, 0, 'solid', 'transparent', 'transparent', 'en', 0.43, 0.73, '#ffffff', 'template_5', 'Book Now', NULL, 'primary'),
...
-- Inserting text data for template_6
  ...
  ('18', 'cta', 36, 'RobotoCondensed-Black', 'bold', 'none', 'normal', 10, 1, 'solid', '#fff', 'transparent', 'en', 0.16, 0.87, '#ffffff', 'template_6', 'Book Now', NULL, 'primary');
